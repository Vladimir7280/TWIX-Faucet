...
7. Access the Faucet on your web browser. The default may be http://127.0.0.1:4000. If you get a "connection refused" or "init failed" error, check your .env file.
***
## Feature status
